...
public class FeedService implements FeedInterface {
    ...
    public void addFeed(Feed feed) {
        String query = "INSERT INTO feed (email_feed, commentaire_feed, subject_feed, date_feed, name_feed, is_processed) " +
                      "VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void updateFeed(Feed feed) {
        String query = "UPDATE feed SET email_feed = ?, commentaire_feed = ?, subject_feed = ?, " +
                      "date_feed = ?, name_feed = ?, is_processed = ? WHERE id = ?";
